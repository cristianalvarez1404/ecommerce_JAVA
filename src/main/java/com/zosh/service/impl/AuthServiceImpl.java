...
public class AuthServiceImpl implements AuthService {
    ...
    public void sentLoginOtp(String email) throws Exception {
        ...
        String subject = "John doe login/signup otp";
    ...
    public String createUser(SignupRequest req) throws Exception {
        ...
        if(verificationCode == null || !verificationCode.getOtp().equals(req.getOpt())){
        ...
        if(user == null){
            ...
            createdUser.setPassword(passwordEncoder.encode(req.getOpt()));
